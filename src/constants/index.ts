import type { Skill, Experience, SocialLink, ServiceItem, ProjectItem, TestimonialItem } from '@/types';
import defaultProfile from '@/assets/profile.png';
import defaultProject1 from '@/assets/project1.png';
    ...
    experience: [
      ...
      },
      {
        ...
        role: {
          ...
          es: 'Desarrollador Frontend', hi: 'फ्रंटएंड डेवलपर', it: 'Sviluppatore Frontend', pt: 'Desenvolvedor Frontend', ru: 'Фронтенд-разработчик',
        },
      ...
      },
      {
        ...
        role: {
          ...
          fr: 'Designer UI & Développeur Web', de: 'UI-Designer & Webentwickler', ar: 'مصمم UI ومطور ويب', bn: 'ইউআই ডিজাইনার এবং ওয়েব ডেভেলপার',
  ...
  projects: [
    {
      ...
      image: defaultProject1, liveLink: '#', githubLink: '#', tags: ['React', 'TypeScript', 'Tailwind', 'Recharts'],
    },
    {
      id: '2',
      title: {
      ...
      image: defaultProject1, liveLink: '#', githubLink: '#', tags: ['Vite', 'Zustand', 'Tailwind', 'Framer Motion'],
    },
  ] as ProjectItem[],
  testimonials: [
    {
